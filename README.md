...
To run the application, clone the code from the following GitHub link [git@github.com:tyedem/Project-3.git]. For a visual step by step guide, you can proceed direction to Video Demos section.
